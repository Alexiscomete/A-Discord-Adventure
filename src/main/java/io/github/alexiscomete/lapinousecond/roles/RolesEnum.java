...
public enum RolesEnum {
    ...
    SERVER_ADMIN((id) -> new DefaultRole(10, 10000000, "Administrateur de serveur", "Pour tout admin sur un serveur, à donner à toute personne qui doit gérer les permissions des rôles", id, "SERVER_ADMIN")),

...
public enum RolesEnum {
    ...
    SERVER_ADMIN((id) -> new DefaultRole(10, 10000000, "Administrateur de serveur", "Pour tout admin sur un serveur, à donner à toute personne qui soit gérer les permissions des rôles", id, "SERVER_ADMIN")),
    GOUV((id) -> new DefaultRole(200, 1000000, "Membre de l'assemblé", "Les membres de l'assemblé de la RPDB peuvent demander à avoir ce rôle", id, "GOUV")),

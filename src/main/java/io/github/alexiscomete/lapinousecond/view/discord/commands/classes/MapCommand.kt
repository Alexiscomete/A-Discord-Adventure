...
val TRAVEL_MENU = MenuBuilderFactoryUI(
    "Voyager",
...
val MAIN_MENU_MAP = MenuBuilderFactoryUI(
    "Carte 🗺",
...
class MapCommand : Command(
    ...
    override fun execute(slashCommand: SlashCommandInteraction) {
        ...
        ui.setLongCustomUI(MAIN_MENU_MAP.build(ui))
        ui.updateOrSend()
        context.ui(ui)
    }
}
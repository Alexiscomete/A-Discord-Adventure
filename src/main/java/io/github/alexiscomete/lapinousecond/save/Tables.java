...
public enum Tables {
    ...
    PLACES(new Table("places", new TableRow[]{new TableRow("id", "INTEGER PRIMARY KEY"), new TableRow("serv", "INTEGER"), new TableRow("name", "TEXT")}));

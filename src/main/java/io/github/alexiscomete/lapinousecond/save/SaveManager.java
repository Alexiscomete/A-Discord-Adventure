    ...
    public Player getPlayer(long l) {
        ...
        if (p == null) {
            try {
                ...
                if (resultSet.next()) {
                    p = new Player(resultSet.getLong("id"), resultSet.getLong("bal"), resultSet.getLong("serv"), resultSet.getShort("tuto"), resultSet.getBoolean("is_verify"), resultSet.getBoolean("has_account"), resultSet.getInt("x"), resultSet.getInt("y"), resultSet.getString("roles"));
                    players.put(l, p);
                }

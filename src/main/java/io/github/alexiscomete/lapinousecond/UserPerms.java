...
public class UserPerms {
    ...
    public final boolean PLAY, CREATE_SERVER, SET_SERVER_SEC, MANAGE_PERMS;

    public UserPerms(boolean PLAY, boolean CREATE_SERVER, boolean SET_SERVER_SEC, boolean MANAGE_PERMS) {
        this.PLAY = PLAY;
